import { fetchProductsDisplay } from "@/app/actions/dashboard/productAPI/service";
...
const HorizontalProductScroll = ({ products }: { products: ProductTrue[] }) => {
  /*  const [products, setProducts] = useState<Product[]>([]); */
  const router = useRouter();
  const [productsDisplay, setProductsDisplay] = useState<ProductTrue[]>([]);
  ...
  useEffect(() => {
    /*  const getProductsDisplay = async () => {
      const product: ProductTrue[] = await fetchProductsDisplay(false, true);
      setProductsDisplay(product);
    };
    getProductsDisplay(); */
  ...
  return (
    <div className="relative px-4 py-8 ">
      <h2 className="text-2xl font-bold mb-6">Produits en Solde</h2>
